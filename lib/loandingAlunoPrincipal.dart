...
class LoandingAluno extends StatefulWidget {
  @override
  _LoandingAlunoState createState() => _LoandingAlunoState();
}

class _LoandingAlunoState extends State<LoandingAluno>
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 7), () {
      ...
      Navigator.pushNamedAndRemoveUntil(
          context, '/telaAluno', (Route<dynamic> route) => false);
    });
  }
